  ...
  <div class="card border-0 mb-3 p-3 shadow-sm">
    ...
    <div class="row gy-4 gx-2 align-items-center">
      ...
      <div class="col-12 col-md-4 col-lg-3 text-center">
        ...
        <a href="#" class="text-dark ms-2 btn-calendar" data-request-id="{{ $request->id }}" title="Ubah Tanggal">
          <i class="bi bi-calendar"></i>
        </a>
        @endif
        @elseif($request->status == 'submitted')
        <a href="#" class="text-dark btn-calendar" data-request-id="{{ $request->id }}" title="Pilih Tanggal">
